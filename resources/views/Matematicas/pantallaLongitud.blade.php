        ...
        <div class="col-md-6  ">
            <div class="card mx-auto d-block" style="width: 18rem; background: #d5f5fa">
                ...
                <div class="card-body">
                    ...
                    <a href="http://learningkids.test/unidadLongitud" style=" background: #FF7800" href="" class="btn btn-primary">Leer</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 ">
            <div class="card mx-auto d-block" style="width: 18rem; background: #d5f5fa">
                ...
                <div class="card-body">
                    ...
                    <a href="http://learningkids.test/unidadCorporal#" style=" background: #FF7800" class="btn btn-primary">Leer</a>
                </div>
            </div>
        </div>
    </div>
