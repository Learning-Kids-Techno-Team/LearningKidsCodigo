    ...
    <div class="row " >
        <div class="col-xl-12 p-2">
            <div class="card" style="width: 26rem;">
                 <iframe src="https://drive.google.com/file/d/1JA2SKHmUjkosTPVCqigPmZug3cceCka7/preview" width="400" height="200"></iframe>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-6 mt-n3">
            <img class="mx-auto d-block" src="https://i.ibb.co/WGXbXTF/Captura-de-pantalla-280-removebg-preview.png" width="380">
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-6 mt-n3">
            <img class="mx-auto d-block" src="https://i.ibb.co/CbjK7dD/Captura-de-pantalla-282-removebg-preview.png" width="400">
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-6 mt-n3">
            <img class="mx-auto d-block" src="https://i.ibb.co/p3kqH0H/Captura-de-pantalla-285-removebg-preview.png"  width="400">
        </div>
    </div>
</div>
    ...
    <div class="row" >
        <div class="col-xl-6 pb-4">
            <div class="card mx-auto d-block " style="width: 26rem;">
                <img   src="https://i.ibb.co/9ZgQd5s/Captura-de-pantalla-311.png" width="400"  height="400" >

            </div>
        </div>
        <div class="col-xl-6 pb-4">
            <div class="card mx-auto d-block " style="width: 26rem;">
                <img src="https://i.ibb.co/k3kqS39/Captura-de-pantalla-309.png"   width="400" height="400">
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-6 pb-4">
            <div class="card mx-auto d-block " style="width: 26rem;">
                <img   src="https://i.ibb.co/6FFHchy/Captura-de-pantalla-313.png"  width="400" height="400"  >

            </div>
        </div>
        <div class="col-xl-6 pb-4">
            <div class="card mx-auto d-block " style="width: 26rem;">
                <img  src="https://i.ibb.co/2FqB1yK/Captura-de-pantalla-315.png"   width="400" height="400">
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row" >
        <div class="col-xl-6 pb-4">
            <div class="card mx-auto d-block " style="width: 26rem;">
                <img   src="https://i.ibb.co/y4F5Ggp/Captura-de-pantalla-318.png"     width="400" height="400" >

            </div>
        </div>
        <div class="col-xl-6 pb-4">
            <div class="card mx-auto d-block " style="width: 26rem;">
                <img src="https://i.ibb.co/bdQhqG1/Captura-de-pantalla-321.png"     width="400" height="400">
            </div>
        </div>
    </div>
</div>
