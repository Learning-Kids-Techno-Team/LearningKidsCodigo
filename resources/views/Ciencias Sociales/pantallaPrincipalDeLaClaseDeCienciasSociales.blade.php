...
<div class="container-fluid">
    ...
    <div class="container-fluid"style="background: #B8DA97">
        <div class="row">
            ...
            <div class="col-md-4 pb-3">
                <img alt="Vista previa de la imagen de Bootstrap" src="https://i.ibb.co/tcpvYgs/ciencias-sociales-removebg-preview.png" class="mx-auto d-block" width="400" >
            </div>
            <div class="col-md-4 pb-5">
    ...
    <div class="container-fluid" style="background: #B8DA97">
        <div class="row ">
            ...
            <div class="col-md-4 pb-5" align="right">
