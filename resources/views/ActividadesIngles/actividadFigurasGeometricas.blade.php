...
<head>
    ...
    <title>Actividad Figuras Geometricas</title>
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-m-12 mx-auto d-block" style="background:#FBE9A0;">
                <div >
                    <h1 style="text-align: center">Actividad Figuras Geometricas</h1>
                </div>

                <div>

                    <iframe src="https://eomweezz5vxhz8pwddk6ug-on.drv.tw/Ingles/Figuras%20Geometricas%20(Published)/" width="1347" height="700"></iframe>
