...
@section('content')
    ...
    <div class="row">
        <div class="col-m-12">
            <div>
                <h1 style="text-align: center">Actividad de lineas</h1>
            </div>

            <div>
                <iframe src="https://eomweezz5vxhz8pwddk6ug-on.drv.tw/Juegos/Lineas%20(Published)/" width="1347" height="800"></iframe>
            </div>
