        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/bic.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/moto.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/tricicl.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/car.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/camionet.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/convertib.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/bus.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/busdoble.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/busSchoo.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/subway.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/tren.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/teleferic.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/camion.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/basur.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/tractor.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/ambulan.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/patrull.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/taxi.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/van.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/carrera.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/limosin.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/motoneta.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/motonieve.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/segw.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/grua.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/remolq.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/montacarga.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/avion.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/transbordador.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/helicopter.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/cohet.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/globo.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/navespacial.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/velero.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/crucero.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/submarin.mp3" controls >
                    </audio>
        ...
        <div class="card">
            <div class="row m-3">
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/barco.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/motoacuatica.mp3" controls >
                    </audio>
                ...
                <div class="col-md-4">
                    ...
                    <audio  id="player" src="AudioIngles/transportes/balsa.mp3" controls >
                    </audio>
