...
@section('content')
    ...
    <div class="container-fluid" id="color">
        <div class="row mt-5">
            ...
            <div class="col-md-3 pl-5"><br><br>
                <!-- letra A-->
                <img class="rounded-circle d-flex justify-content-center   "  style="border: lightgreen solid 12px" src="https://i.ibb.co/ZJgXBFC/Captura-de-pantalla-566.png"     width="300" height="300"/><br>
            ...
            <div class="col-md-3  "><br><br><br><br>
                <!-- letra B-->
                <img class="rounded-circle d-flex justify-content-center " style="border: lightgreen solid 12px" src="https://i.ibb.co/yh8b3wS/Captura-de-pantalla-567.png"  width="330" height="300"/><br>
            ...
            <div class="col-md-3  "><br><br><br>
                <!-- letra C-->
                <img class="rounded-circle d-flex justify-content-center" style="border: lightgreen solid 12px"  src="https://i.ibb.co/cQJd23S/Captura-de-pantalla-568.png"   width="300" height="300"/><br>
                <div class="card ml-5 " style="width: 10rem; ">
    ...
    <div class="container-fluid" id="color">
        <div class="row ">
            <div class="col-md-3 pl-4"><br><br><br><br><br>
                <img class="rounded-circle d-flex justify-content-center"  style="border: lightgreen solid 12px" src="https://i.ibb.co/wwj7xgD/Captura-de-pantalla-572.png"    width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br><br>
                <!-- letra f -->
                <img class="rounded-circle d-flex justify-content-center"  style="border: lightgreen solid 12px"  src="https://i.ibb.co/tBfbYvZ/Captura-de-pantalla-571.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br>
                <!-- letra E -->
                <img class="rounded-circle d-flex justify-content-center " style="border:lightgreen solid 12px" src="https://i.ibb.co/6WbQzGQ/Captura-de-pantalla-570.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3  pl-5">
                <!-- letra D -->
                <img class="rounded-circle d-flex justify-content-center" style="border: lightgreen solid 12px"  src="https://i.ibb.co/YNxxRhG/Captura-de-pantalla-569.png"  width="300" height="300"/><br>
                <div class="card ml-5 " style="width: 10rem; ">
    ...
    <div class="container-fluid" id="color">
        <div class="row ">
            ...
            <div class="col-md-3 pl-5"><br><br>
                <!-- letra h-->
                <img class="rounded-circle d-flex   "  style="border:lightgreen solid 12px" src="https://i.ibb.co/16stnrP/Captura-de-pantalla-573.png"    width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br>
                <!-- letra i-->
                <img class="rounded-circle d-flex"  style="border: lightgreen solid 12px" src="https://i.ibb.co/37k0bWP/Captura-de-pantalla-598.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3  "><br><br><br><br><br><br><br>
                <!-- letra j-->
                <img class="rounded-circle d-flex justify-content-center " style="border: lightgreen solid 12px"  src="https://i.ibb.co/5L6Wwyy/Captura-de-pantalla-594.png" width="300" height="300"/><br>
            ...
            <div class="col-md-3  "><br><br><br><br><br><br><br><br>
                <!-- letra k-->
                <img class="rounded-circle d-flex justify-content-center" style="border: lightgreen solid 12px" src="https://i.ibb.co/h2y62P1/Captura-de-pantalla-575.png"  width="300" height="300"/><br>
                <div class="card ml-5 " style="width: 10rem; ">
    ...
    <div class="container-fluid" id="color">
        <div class="row ">
            <div class="col-md-3 pl-4"><br><br><br><br><br><br><br><br>
                <img class="rounded-circle d-flex justify-content-center"  style="border: lightgreen solid 12px" src="https://i.ibb.co/cF8CTx8/Captura-de-pantalla-579.png"   width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br><br><br><br>
                <!-- letra N-->
                <img class="rounded-circle d-flex justify-content-center"  style="border: lightgreen solid 12px" src="https://i.ibb.co/8Y51nWL/Captura-de-pantalla-578.png"   width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br><br>
                <!-- letra M -->
                <img class="rounded-circle d-flex justify-content-center " style="border:lightgreen solid 12px" src="https://i.ibb.co/KxS7n7V/Captura-de-pantalla-577.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3  pl-5"><br><br>
                <!-- letra L-->
                <img class="rounded-circle d-flex justify-content-center" style="border: lightgreen solid 12px"   src="https://i.ibb.co/cTmnhhm/Captura-de-pantalla-576.png"   width="300" height="300"/><br>
                <div class="card ml-5 " style="width: 10rem; ">
    ...
    <div class="container-fluid" id="color">
        <div class="row ">
            ...
            <div class="col-md-3 pl-5"><br><br>
                <!-- letra p-->
                <img class="rounded-circle d-flex   "  style="border: lightgreen solid 12px" src="https://i.ibb.co/p41pvTc/Captura-de-pantalla-580.png"     width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br>
                <!-- letra q-->
                <img class="rounded-circle d-flex"  style="border: lightgreen solid 12px" src="https://i.ibb.co/zV5hy2L/Captura-de-pantalla-581.png" width="300" height="300"/><br>
            ...
            <div class="col-md-3  "><br><br><br><br><br><br><br>
                <!-- letra r-->
                <img class="rounded-circle d-flex justify-content-center " style="border: lightgreen solid 12px"  src="https://i.ibb.co/X31K8xM/Captura-de-pantalla-582.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3  "><br><br><br><br><br><br><br><br>
                <!-- letra s-->
                <img class="rounded-circle d-flex justify-content-center" style="border: lightgreen solid 12px" src="https://i.ibb.co/p1TXZq7/Captura-de-pantalla-583.png"  width="300" height="300"/><br>
                <div class="card ml-5 " style="width: 10rem; ">
    ...
    <div class="container-fluid" id="color">
        <div class="row ">
            <div class="col-md-3 pl-4"><br><br><br><br><br><br><br><br>
                <img class="rounded-circle d-flex justify-content-center"  style="border: lightgreen solid 12px" src="https://i.ibb.co/bmdzY3t/Captura-de-pantalla-601.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br><br><br><br>
                <!-- letra V-->
                <img class="rounded-circle d-flex justify-content-center"  style="border: lightgreen solid 12px"  src="https://i.ibb.co/7NXwy2n/Captura-de-pantalla-586.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br><br>
                <!-- letra u -->
                <img class="rounded-circle d-flex justify-content-center " style="border: lightgreen solid 12px" src="https://i.ibb.co/RHBpZp9/Captura-de-pantalla-600.png"   width="300" height="300"/><br>
            ...
            <div class="col-md-3  pl-5"><br><br>
                <!-- letra t-->
                <img class="rounded-circle d-flex justify-content-center" style="border: lightgreen solid 12px" src="https://i.ibb.co/232xDXG/Captura-de-pantalla-584.png"  width="300" height="300"/><br>
                <div class="card ml-5 " style="width: 10rem; ">
    ...
    <div class="container-fluid" id="color">
        <div class="row ">
            ...
            <div class="col-md-3 pl-5"><br><br>
                <!-- letra x-->
                <img class="rounded-circle d-flex   "  style="border: lightgreen solid 12px"  src="https://i.ibb.co/G9KxXJz/Captura-de-pantalla-588.png"  width="300" height="300"/><br>
            ...
            <div class="col-md-3 pl-5"><br><br><br><br>
                <!-- letra y-->
                <img class="rounded-circle d-flex"  style="border: lightgreen solid 12px" src="https://i.ibb.co/PNB0hQ5/Captura-de-pantalla-589.png" width="300" height="300"/><br>
            ...
            <div class="col-md-3  "><br><br><br><br><br><br><br>
                <!-- letra z-->
                <img class="rounded-circle d-flex justify-content-center " style="border: lightgreen solid 12px" src="https://i.ibb.co/gSyn006/Captura-de-pantalla-590.png"  width="300" height="300"/><br>
