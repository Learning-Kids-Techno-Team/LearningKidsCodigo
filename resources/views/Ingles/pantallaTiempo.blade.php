    ...
    <div class="container-fluid" id="dif">
        <div class="row" >
            <div class="col-md-12" id="fondo">
                <img  class=" mx-auto d-block" src="https://i.ibb.co/j9CkdRN/comp-removebg-preview.png"/>
            </div>
        </div>
    </div>
    ...
    <div id="separadorDePagina" class="container-fluid">
        <div class="row">
            <div class="mx-auto d-block">
                <img  width="340" height="250" class="mx-auto d-block" src="https://i.ibb.co/xYDY0yQ/lpo-removebg-preview.png">
